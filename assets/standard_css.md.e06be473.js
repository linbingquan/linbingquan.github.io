import{_ as s,c as n,o as a,O as l}from"./chunks/framework.2ed03d8f.js";const d=JSON.parse('{"title":"前端规范 css","description":"","frontmatter":{},"headers":[],"relativePath":"standard/css.md","filePath":"standard/css.md"}'),p={name:"standard/css.md"},o=l(`<h1 id="前端规范-css" tabindex="-1">前端规范 css <a class="header-anchor" href="#前端规范-css" aria-label="Permalink to &quot;前端规范 css&quot;">​</a></h1><blockquote><p>代码千万行，注释第一行。命名不规范，同事两行泪。</p></blockquote><h3 id="一、css-书写顺序" tabindex="-1">一、css 书写顺序 <a class="header-anchor" href="#一、css-书写顺序" aria-label="Permalink to &quot;一、css 书写顺序&quot;">​</a></h3><ol><li>位置属性(position, top, right, z-index, display, float等)</li><li>大小(width, height, padding, margin)</li><li>文字系列(font, line-height, letter-spacing, color, text-align等)</li><li>背景(background, border等)</li><li>其他(animation, transition等)</li></ol><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">.</span><span style="color:#FFCB6B;">container</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#89DDFF;">}</span></span></code></pre></div><h3 id="二、css-书写规范" tabindex="-1">二、css 书写规范 <a class="header-anchor" href="#二、css-书写规范" aria-label="Permalink to &quot;二、css 书写规范&quot;">​</a></h3><ol><li><p>使用 css 缩写属性</p><ul><li>css 有些属性是可以缩写的，比如padding, margin, font等等，这样精简代码同时又能提高用户的阅读体验。</li></ul></li><li><p>去掉小数点前的 0</p><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">/* bad */</span></span>
...
<span class="line"><span style="color:#89DDFF;">.</span><span style="color:#FFCB6B;">container</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span><span style="color:#A6ACCD;"> </span><span style="color:#B2CCD6;">font-size</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#F78C6C;">.8em</span><span style="color:#89DDFF;">;</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">}</span></span></code></pre></div></li><li><p>简写命名</p><ul><li>很多用户都喜欢简写类名，但前提是要让人看懂你的命名才能简写哦！</li></ul></li><li><p>16进制颜色代码缩写</p><ul><li>有些颜色代码是可以缩写的，我们就尽量缩写吧，提高用户体验为主。</li></ul><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">/* bad */</span></span>
<span class="line"><span style="color:#89DDFF;">.</span><span style="color:#FFCB6B;">container</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span><span style="color:#A6ACCD;"> </span><span style="color:#B2CCD6;">color</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">#</span><span style="color:#A6ACCD;">ffffff</span><span style="color:#89DDFF;">;</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">/* good */</span></span>
<span class="line"><span style="color:#89DDFF;">.</span><span style="color:#FFCB6B;">container</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span><span style="color:#A6ACCD;"> </span><span style="color:#B2CCD6;">color</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">#</span><span style="color:#A6ACCD;">fff</span><span style="color:#89DDFF;">;</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">}</span></span></code></pre></div></li><li><p>连字符 css 选择器命名规范</p><ul><li>长名称或词组可以使用中横线 <code>-</code> 来为选择器命名。</li><li>不建议使用 <code>_</code> 下划线来命名 css 选择器，为什么呢？ 输入的时候少按一个shift键； 浏览器兼容问题 （比如使用_tips的选择器命名，在IE6是无效的） 能良好区分JavaScript变量命名（JS变量命名是用<code>_</code>）</li></ul></li><li><p>不要随意使用ID</p><ul><li>ID在JS是唯一的，不能多次使用，而使用class类选择器却可以重复使用，另外ID的优先级优先与class，所以ID应该按需使用，而不能滥用。</li></ul></li><li><p>为选择器添加状态前缀</p><ul><li>有时候可以给选择器添加一个表示状态的前缀，让语义更明了，比如下图是添加了 <code>.is-</code>前缀。</li></ul></li></ol><h3 id="三、css-命名规范-规则" tabindex="-1">三、css 命名规范（规则） <a class="header-anchor" href="#三、css-命名规范-规则" aria-label="Permalink to &quot;三、css 命名规范（规则）&quot;">​</a></h3><h4 id="常用的-css-命名规则" tabindex="-1">常用的 css 命名规则 <a class="header-anchor" href="#常用的-css-命名规则" aria-label="Permalink to &quot;常用的 css 命名规则&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">头：header</span></span>
...
<span class="line"><span style="color:#A6ACCD;">合作伙伴：partner</span></span></code></pre></div><h4 id="注释的写法" tabindex="-1">注释的写法: <a class="header-anchor" href="#注释的写法" aria-label="Permalink to &quot;注释的写法:&quot;">​</a></h4><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">/* Header */</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;">/* End Header */</span></span></code></pre></div><h4 id="id的命名" tabindex="-1">ID的命名: <a class="header-anchor" href="#id的命名" aria-label="Permalink to &quot;ID的命名:&quot;">​</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">(1)页面结构</span></span>
...
<span class="line"><span style="color:#A6ACCD;">版权：copyright</span></span></code></pre></div><h3 id="四、注意事项" tabindex="-1">四、注意事项 <a class="header-anchor" href="#四、注意事项" aria-label="Permalink to &quot;四、注意事项&quot;">​</a></h3><ol><li>一律小写</li><li>尽量用英文</li><li>不加中槓和下划线</li><li>尽量不缩写，除非一看就明白的单词</li></ol><h3 id="五、css-样式表文件命名" tabindex="-1">五、css 样式表文件命名 <a class="header-anchor" href="#五、css-样式表文件命名" aria-label="Permalink to &quot;五、css 样式表文件命名&quot;">​</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">主要的 master.css</span></span>
...
<span class="line"><span style="color:#A6ACCD;">打印 print.css</span></span></code></pre></div>`,18),e=[o];function c(t,r,i,C,A,D){return a(),n("div",null,e)}const F=s(p,[["render",c]]);export{d as __pageData,F as default};
