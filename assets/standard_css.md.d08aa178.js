...
<span class="line"></span></code></pre></div><h3 id="二、css-书写规范" tabindex="-1">二、css 书写规范 <a class="header-anchor" href="#二、css-书写规范" aria-hidden="true">#</a></h3><ol><li><p>使用 css 缩写属性</p><ul><li>css 有些属性是可以缩写的，比如padding, margin, font等等，这样精简代码同时又能提高用户的阅读体验。</li></ul></li><li><p>去掉小数点前的 0</p><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">/* bad */</span></span>
...
<span class="line"></span></code></pre></div></li><li><p>简写命名</p><ul><li>很多用户都喜欢简写类名，但前提是要让人看懂你的命名才能简写哦！</li></ul></li><li><p>16进制颜色代码缩写</p><ul><li>有些颜色代码是可以缩写的，我们就尽量缩写吧，提高用户体验为主。</li></ul><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">/* bad */</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h4 id="注释的写法" tabindex="-1">注释的写法: <a class="header-anchor" href="#注释的写法" aria-hidden="true">#</a></h4><div class="language-css"><button title="Copy Code" class="copy"></button><span class="lang">css</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">/* Header */</span></span>
...
<span class="line"></span></code></pre></div><h4 id="id的命名" tabindex="-1">ID的命名: <a class="header-anchor" href="#id的命名" aria-hidden="true">#</a></h4><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">(1)页面结构</span></span>
...
<span class="line"><span style="color:#A6ACCD;">版权：copyright</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="四、注意事项" tabindex="-1">四、注意事项 <a class="header-anchor" href="#四、注意事项" aria-hidden="true">#</a></h3><ol><li>一律小写</li><li>尽量用英文</li><li>不加中槓和下划线</li><li>尽量不缩写，除非一看就明白的单词</li></ol><h3 id="五、css-样式表文件命名" tabindex="-1">五、css 样式表文件命名 <a class="header-anchor" href="#五、css-样式表文件命名" aria-hidden="true">#</a></h3><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">主要的 master.css</span></span>
